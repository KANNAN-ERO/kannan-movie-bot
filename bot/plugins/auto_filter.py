...
async def auto_filter(bot, update):
    ...
    if filters:
      ...
      f for filter in filters: # iterating through each files
            ...
            if file_size < 1024:
                ...
                file_size = f"[{str(round(file_size/1024, 2))} 𝐊𝐁] "
            elif file_size < (1024**3):
                file_size = f"[{str(round(file_size/(1024**2), 2))} 𝐌𝐁] "
            elif file_size < (1024**4):
                file_size = f"[{str(round(file_size/(1024**3), 2))} 𝐆𝐁] "
    ...
    if len(results) == 0: # double check
        ...
        try:
            await bot.send_photo(
                ...
                photo="https://telegra.ph/file/3164c4bcf64099630f8ff.jpg",
                caption=f"""<b>𝐆𝐫𝐨𝐮𝐩:- @cineblasters 
